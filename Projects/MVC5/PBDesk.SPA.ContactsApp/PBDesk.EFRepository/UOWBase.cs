...
namespace PBDesk.EFRepository
{
    public class UOWBase : IDisposable
    {
        ...
        public UOWBase(string lastUpdBy)
        {
            this.LastUpdBy = lastUpdBy ?? string.Empty;            
        }
        ...
        {
            UpdateAuditInfo(obj, this.LastUpdBy, DateTime.Now);
        ...
        {
            UpdateAuditInfo(obj, this.LastUpdBy, lastUpdDate);
